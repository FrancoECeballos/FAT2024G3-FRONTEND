...
const SearchBar = ({ onSearchChange, onOrderChange, filters = [], style }) => {
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', margin: '0 auto', ...style, marginBottom:'1rem' }}>
            ...
            <Dropdown>
                <Dropdown.Toggle 
                    id="dropdown-basic"
                    style={{ height: "2.5rem", border: '0px', color: 'black', borderRadius: '10rem', backgroundColor: '#F5F5F5', boxShadow: '0.10rem 0.3rem 0.20rem rgba(0, 0, 0, 0.3)', textAlign: 'center' }}>
