    ...
    return (
        <div className="flex-grow-1 d-flex flex-column align-items-center">
            ...
            <div className="mb-2">
                ...
                />
                {usingIcon ? (
                    <Icon onClick={handleFileButtonClick} icon="line-md:edit-twotone" style={{ width: '1.5rem', height: '1.5rem', alignContent: 'center' }} hidden={buttonHidden}> </Icon>
                ) : (
                    <SendButton onClick={handleFileButtonClick} text="Seleccionar Archivo" wide={wide} backcolor="#02005D" letercolor='white' radius='0.5rem' shadow='none' hid={buttonHidden}>
