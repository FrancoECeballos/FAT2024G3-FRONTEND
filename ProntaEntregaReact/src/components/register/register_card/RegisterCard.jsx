              ...
              <Col xs={12} sm={8} md={8} lg={8} xl={8} xxl={8}>
                <Form>
                  ...
                  <Form.Group className="mb-2" controlId="formBasicPasswordConfirm">
                    ...
                    <Form.Control id='FormConfirmar' type="password" placeholder="Ingrese nuevamente su contraseña" style={{ borderRadius: '10rem', backgroundColor: '#F5F5F5', boxShadow: '0.10rem 0.3rem 0.20rem rgba(0, 0, 0, 0.3)' }} />
                  </Form.Group>
