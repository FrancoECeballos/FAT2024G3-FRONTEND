...
const RegisterCard = () => {
  ...
  const [alertMessage, setAlertMessage] = useState(
    "Los campos fueron ingresados incorrectamente",
  );
  ...
  useEffect(() => {
    ...
    img.onload = () => {
      ...
      canvas.toBlob((blob) => {
        const file = new File([blob], "user_default.png", {
          type: "image/png",
        });
    ...
    if (name === "calle" || name === "numero" || name === "localidad") {
      ...
      if (name === "documento") {
        ...
        if (value === "") {
          ...
          errorDocumento.innerHTML = !regex.test(value)
            ? "El numero de documento es inválido"
            : "&nbsp;";
        }
      } else if (name === "email") {
        const regex = /@/;
        ...
        if (value === "") {
          ...
          errorEmail.innerHTML = !regex.test(value)
        ...
        if (value === "") {
          ...
          errorTelefono.innerHTML = !regex.test(value)
            ? "El teléfono necesita 10 numeros"
            : "&nbsp;";
        }
        ...
        const errorConfirmarContrasenia =
  ...
  const handleSendData = async (event) => {
    ...
    if (
      ...
      !formData.email ||
      !formData.genero ||
      !formData.id_tipodocumento ||
      !direcFormData.calle ||
      !direcFormData.numero ||
      !direcFormData.localidad
    ) {
      ...
      <Container className="d-flex justify-content-center align-items-center register-container">
        ...
        >
          <Card.Body>
            ...
            <Form.Label className="font-rubik" style={{ fontSize: "1.3rem" }}>
              Registro:
            </Form.Label>
            <GenericAlert
              ptamaño="0.9"
              ...
              <Row>
                ...
                <Col xs={12} sm={12} md={12} lg={6} xl={6} xxl={6}>
                  ...
                  >
                    ...
                    <SelectLocalidad
                      onSelect={handleLocalidadChange}
                      onChange={() =>
                        setDirecFormData((...prevData) => ({
                          ...prevData,
                          localidad: "",
                  ...
                  <Form.Group
                    className="mb-2"
                    style={{ maxHeight: "6.2979rem", borderRadius: "none" }}
                  >
                    <Form.Label
                      className="font-rubik"
                      style={{ fontSize: "0.8rem" }}
